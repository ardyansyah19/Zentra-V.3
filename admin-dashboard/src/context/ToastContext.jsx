...
import { CheckCircle2, PackageSearch, ShoppingBag, X } from 'lucide-react';
        ...
        {toasts.map((t) => {
          ...
          return (
            <div key={t.id} className="animate-slideIn card p-3.5 flex items-start gap-3">
              <div className="w-9 h-9 rounded-full bg-mint-500/15 text-mint-600 flex items-center justify-center shrink-0">
                <Icon size={18} />
              </div>
