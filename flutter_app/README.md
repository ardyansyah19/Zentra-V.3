# Zentra Store — Aplikasi Customer (Flutter)
...
- Beranda dengan banner promo, kategori, produk featured & populer
- Pencarian & filter produk per kategori
- Detail produk (pilih ukuran, rating, deskripsi, stok realtime)
- Keranjang belanja & checkout (alamat + metode pembayaran)
