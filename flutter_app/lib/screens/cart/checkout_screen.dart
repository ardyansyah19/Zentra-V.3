                  ...
                  children: [
                    ...cart.lines.map((l) => Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text('\$${l.subtotal.toStringAsFixed(0)}', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                            ],
                          ),
                        )),
                    ...
                    Row(
                      children: [
                        ...
                        Text('\$${cart.total.toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 18, color: AppColors.brand)),
                      ],
                    ),
                  ],
                ),
